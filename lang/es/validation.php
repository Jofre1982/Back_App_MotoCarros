...
// Laravel (historia técnica #73). La mayoría de los mensajes propios del
// proyecto ya se escriben en español directamente en los Form Requests
// (ver .claude/STANDARDS.md) — este archivo cubre las reglas automáticas
// (`required`, `email`, `unique`, etc.) que antes salían en inglés.
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado apareció en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    // Nombres de campo en español para que las reglas automáticas (arriba)
    // generen frases naturales, p. ej. "El campo correo electrónico es
    // obligatorio" en vez de "El campo email es obligatorio". Cubre los
    // campos que hoy validan los Form Requests del proyecto.
    'attributes' => [
        'code' => 'código',
        'comment' => 'comentario',
        'destination' => 'destino',
